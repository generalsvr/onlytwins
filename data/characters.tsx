import type { CharacterProfileData } from '@/components/character-profile-template';
import type { CharacterChatData } from '@/components/chat/character-chat-template';
...
// Character chat data
export const CHARACTER_CHATS: Record<string, CharacterChatData> = {
  claire: {
    id: 1,
    name: 'Claire',
  ...
  hana: {
    id: 5,
    name: 'Hana',
    image: '/hana-black-lingerie.webp',
    isOnline: true,
    lastSeen: 'Active now',
    agentId: 'yV4wd6xrm1fUcbFUKJax',
  },
