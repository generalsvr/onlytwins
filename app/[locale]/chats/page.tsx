...
export default function ChatPage({ initialConversations, error: initialError, pageSize = 1 }: ChatPageProps) {
  ...
  const filters = useMemo(() => [
    { id: 'all', label: dictionary.chat.allChats, icon: MessageCircle },
    { id: 'unread', label: dictionary.chat.unread, icon: Clock },
    { id: 'online', label: dictionary.chat.online, icon: Star },
    { id: 'filter', label: dictionary.chat.moreFilters, icon: Filter },
  ], [dictionary.chat]);
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm text-zinc-400">
                {conversations?.length || 0} {dictionary.chat.conversations}
              </div>
            </div>
            ...
            <div className="relative mb-4">
              ...
              >
                ...
                <input
                  type="text"
                  placeholder={dictionary.chat.searchConversations}
        ...
        {displayError && (
          <div className="text-center py-12">
            ...
            <p className="text-red-400 text-lg font-medium mb-2">
              {dictionary.chat.somethingWentWrong}
            </p>
        ...
        {!displayError && conversations && conversations.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">
              {dictionary.chat.noConversationsYet}
            </h3>
            <p className="text-zinc-400 mb-6">
              {dictionary.chat.startChattingDesc}
            </p>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    `}>
                      {chat.lastMessage || dictionary.chat.noMessagesYet}
                    </p>
                ...
                >
                  {isLoadingMore ? (
                    <div className="flex items-center space-x-2">
                      ...
                      <span>{dictionary.chat.loading}</span>
                    </div>
                  ) : (
                    dictionary.chat.loadMore
                  )}
                </button>
              </div>
            )}
        ...
        {!displayError && searchQuery && filteredConversations?.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">
              {dictionary.chat.noResultsFound}
            </h3>
            <p className="text-zinc-400">
              {dictionary.chat.tryDifferentKeywords}
            </p>
          </div>
        )}
      </div>
