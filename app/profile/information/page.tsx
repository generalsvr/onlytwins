...
import { ArrowLeft, Camera, Edit, Save, X, User, Mail, Calendar, Crown, Check } from 'lucide-react';
        ...
        >
          ...
          {isEditing ? (
            ...
            <div className="bg-zinc-800/30 border border-zinc-700/30 rounded-xl px-4 py-3 text-zinc-300 min-h-[8rem] flex items-start">
              {formData.bio || "Hi there! I'm a user of OnlyTwins. I enjoy chatting with AI characters and exploring new experiences."}
            </div>
          )}
        </motion.div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100 text-sm">Don't forget to save your changes</p>
                  </div>
                </div>
                <button
                  onClick={handleSave}
