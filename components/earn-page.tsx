...
export default function EarnPage() {
  ...
  return (
    <div className="pt-16 pb-20 md:pt-20 md:pb-0 md:flex md:flex-col md:min-h-screen">
      <div className="">
        {/* Header */}
        <div className="sticky top-16 md:top-20 z-10 p-4 border-b border-zinc-800 md:rounded-t-xl">
