...
const CharacterInfoCard = ({
  ...
  return (
    <div className="space-y-4 p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl">
      <h2 className="text-xl font-semibold text-white">Character details</h2>
...
export default function CharacterProfileTemplate({
  ...
  useEffect(() => {
    if (galleryMode === 'private' && !isAuthenticated) {
  ...
  }, [galleryMode, isAuthenticated, openModal, closeModal]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        <div className={`${isMobile ? 'px-4' : 'p-6'}`}>
            ...
            <div className="relative pb-4 -mt-16">
              ...
              <div className="mt-4">
                <h1 className="text-2xl font-bold flex items-center text-white">
                  {currentCharacter.name}, {currentCharacter.meta.age || 'N/A'}
                  {currentCharacter.verified && (
              ...
              <div className="flex gap-6 mt-6 border-b border-zinc-800">
                <button
                  ...
                  className={`text-base font-medium pb-3 transition-colors duration-300 relative ${
          ...
          {!isMobile && (
            <div className={'flex items-baseline'}>
              <div className="flex items-center gap-4 mb-8 min-w-[278px]">
                <button
                  onClick={onBack}
              ...
              <div className="flex gap-8 mb-8 border-b border-zinc-800 ml-[136px]">
                <button
                  onClick={() => setActiveTab('information')}
                  className={`text-lg font-medium pb-3 transition-colors duration-300 relative ${
                    activeTab === 'information'
                      ? 'text-white'
                      : 'text-zinc-400 hover:text-white'
                  }`}
          ...
          {/* Main Content Layout */}
          <div className={`${isMobile ? 'mt-3' : 'flex gap-8'}`}>
            {/* Desktop Left Side - Profile Image and Chat Button */}
            {!isMobile && activeTab !== 'gallery' && (
              <div className="w-96 flex-shrink-0">
                ...
                <button
                  className="w-full py-4 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-xl font-medium hover:shadow-lg hover:shadow-pink-500/25 transition-all duration-300 transform hover:scale-[1.02] text-lg"
                  onClick={handleOpenChat}
                >
                  Chat now
                </button>
            ...
            <div className="flex-1">
              ...
              {activeTab === 'gallery' && (
                <div className="space-y-6">
                  ...
                  {/* Gallery Grid */}
                  <div
                    className={`grid ${isMobile ? 'grid-cols-1' : 'xl:grid-cols-3  md:grid-cols-2'} gap-4`}
                  >
                    {galleryMode === 'public' &&
                  ...
                  {((galleryMode === 'public' &&
                    ...
                    (galleryMode === 'private' &&
                      (!currentCharacter.meta.privateContent ||
                        currentCharacter.meta.privateContent.length ===
                          0))) && (
                      ...
                      <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                        <div className="flex flex-col items-center space-y-4">
                          ...
                          <p className="text-zinc-400 text-lg">
                            No {galleryMode} content available yet
                          </p>
                          <p className="text-zinc-500 text-sm">
                            Check back later for{' '}
                            {galleryMode === 'private' ? 'exclusive' : 'more'}{' '}
                            content!
                          </p>
                        </div>
                      </div>
                ...
                <div className="text-center py-12">
                  <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8">
                    <div className="flex flex-col items-center space-y-4">
                      ...
                      <p className="text-zinc-400 text-lg">
                        Bespoke content coming soon
                      </p>
                      <p className="text-zinc-500 text-sm">
                        Custom content tailored just for you!
                      </p>
                    </div>
                  </div>
                </div>
