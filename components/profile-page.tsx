...
import WalletSection from './profile/wallet-section';
import AffiliateSection from './profile/affiliate-section';
import SettingsSection from './profile/settings-section';
import MyCharactersSection from './profile/my-characters-section';
import NotificationsSection from './profile/notifications-section';
import MyProfileSection from './profile/my-profile-section';
...
export default function ProfilePage() {
  ...
  const renderMainSection = () => {
    return (
      <>
        {/* Header */}
        <div className=" from-pink-500 to-purple-600 p-6 md:rounded-xl">
          ...
          {/* Stats */}
          <div className="grid grid-cols-4 gap-2 mt-6 bg-black/20 rounded-xl p-3">
  ...
  return (
    <div className="pt-16 pb-20 md:pt-20 md:pb-0 md:flex md:min-h-screen">
      <div className="md:w-full md:px-6 md:py-8">{renderSection()}</div>
    </div>
  );
}
